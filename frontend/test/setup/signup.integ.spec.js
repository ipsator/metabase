...
describe("setup wizard", () => {
  ...
  it("should allow you to set connection settings for a new database", async () => {
    ...
    setInputValue(databaseStep.find("input[name='name']"), "Ipsator H2");
  ...
  it('should show you scheduling step if you select "Let me choose when Ipsator syncs and scans"', async () => {
