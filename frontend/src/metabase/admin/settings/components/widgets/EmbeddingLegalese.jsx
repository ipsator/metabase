...
const EmbeddingLegalese = ({ onChange }) => (
  <div className="bordered rounded text-measure p4">
    ...
    <p className="text-grey-4" style={{ lineHeight: 1.48 }}>
      {t`In plain english, when you embed charts or dashboards from Ipsator in your own application, that application isn't subject to the Affero General Public License that covers the rest of Ipsator, provided you keep the Ipsator logo and the "Powered by Ipsator" visible on those embeds. You should however, read the license text linked above as that is the actual license that you will be agreeing to by enabling this feature.`}
    </p>
