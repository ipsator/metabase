...
class PremiumTokenInput extends Component {
  ...
  render() {
    ...
    if (errorMessage) {
      ...
      message = t`Enter the token you bought from the Ipsator Store`;
    }
...
const PremiumExplanation = ({ showEnterScreen }) => (
  <div>
    ...
    <p className="mt1">{t`Premium embedding lets you disable "Powered by Ipsator" on your embedded dashboards and questions.`}</p>
