      ...
      <form noValidate>
        <div className="px2" style={{ maxWidth: "585px" }}>
          ...
          <p className="text-grey-4">
            {t`Allows users with existing Ipsator accounts to login with a Google account that matches their email address in addition to their Ipsator username and password.`}
          </p>
          <p className="text-grey-4">
            {jt`To allow users to sign in with Google you'll need to give Ipsator a Google Developers console application client ID. It only takes a few steps and instructions on how to create a key can be found ${(
              <a
                className="link"
