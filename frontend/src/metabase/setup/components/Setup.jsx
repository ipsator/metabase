          ...
          <div className="wrapper wrapper--small">
            <div className="SetupSteps full">
              ...
              <div ref="databaseSchedulingStepContainer">
                {/* Show db scheduling step only if the user has explicitly set the "Let me choose when Ipsator syncs and scans" toggle to true */}
                {databaseDetails &&
