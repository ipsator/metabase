        ...
        <section className="SetupStep rounded full relative SetupStep--active">
          ...
          <div className="mb4">
            <div style={{ maxWidth: 600 }} className="Form-field Form-offset">
              {t`You’ll need some info about your database, like the username and password. If you don’t have that right now, Ipsator also comes with a sample dataset you can get started with.`}
            </div>
